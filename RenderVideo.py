...
def process_image(img_orig):
    ...
    #img = np.dstack((np.zeros_like(seg_img_raw), (dir_binary & mag_binary), color_seg)).astype(np.uint8) * 255 + lane_img_unwarped
...
clip1 = VideoFileClip("source_videos/harder_challenge_video.mp4")
